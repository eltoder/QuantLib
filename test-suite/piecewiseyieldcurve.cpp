...
void testPiecewiseSpreadYieldCurveImpl() {
    ...
    // We rely on LogLinear interpolation to check curve's shape.
    typedef PiecewiseSpreadYieldCurve<SpreadDiscount, LogLinear, Bootstrap> Curve;
