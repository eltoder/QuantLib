...
BOOST_AUTO_TEST_CASE(testMultiCurve) {
    ...
    auto curve3m = multiCurve->addCurve(intcurve3m, ptr3m, ptr3m->multiCurveBootstrapContributor());
    auto curve6m = multiCurve->addCurve(intcurve6m, ptr6m, ptr6m->multiCurveBootstrapContributor());
